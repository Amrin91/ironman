...
const Laundry = () => {
    ...
    <li><strong>Origin</strong>: It has roots dating back to a work by Cicero, specifically  Finibus Bonorum et   written in 45 BC.</li>
    ...
    <li><strong>Standard Text</strong>: The most common version of Lorem Ipsum begins with   ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua </li>
    ...
    <li><strong>Popularity</strong>:  widely used in graphic design, web design, and publishing, making it a staple in creative industries.</li>
    <li><strong>Alternatives</strong>: While Lorem Ipsum is the most recognized placeholder text, other options like   or  exist to suit different themes.</li>
